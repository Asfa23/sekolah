...
class superAdminController extends Controller
{
    public function submitPembayaran(Request $request)
    {
        try {
            ...
            if ($tanggalPembayaran > $today) {
                return redirect('/dashboard/superAdmin/pembayaran')->with('error', 'Tanggal pembayaran tidak boleh melebihi hari ini.');
            }
            ...
            return redirect('/dashboard/superAdmin/pembayaran');
        } catch (\Exception $e) {
    ...
    {
        return view('superAdmin_pembayaran');
        // tambahin halaman ini 
    }
    ...
    public function lihatPembayaranSiswa()
    {
        ...
        return view('superAdmin_lihat_pembayaran_siswa', ['pembayaranSiswa' => $pembayaranSiswa]);
    }
    ...
    public function editPembayaran($id)
    {
        ...
        return view('edit_pembayaran_superAdmin', compact('pembayaran'));
    }
    ...
    public function updatePembayaran(Request $request, $id)
    {
        try {
            ...
            return redirect('/dashboard/superAdmin/lihat_pembayaran_siswa')->with('success', 'Pembayaran berhasil diupdate.');
        } catch (\Exception $e) {
    ...
    public function deletePembayaran($id)
    {
        try {
            ...
            return redirect('/dashboard/superAdmin/lihat_pembayaran_siswa')->with('success', 'Data berhasil dihapus.');
        } catch (\Exception $e) {
            return response()->json(['error' => 'Terjadi kesalahan: ' . $e->getMessage()]);
        }
    }
    ...
    {
        $pembayaran = Pembayaran_Siswa::find($id);
        return view('delete_pembayaran_superAdmin', compact('pembayaran'));
    }
}
