...
@include('partial.sidebar')
    ...
    <main class="w-4/5 p-8">
        ...
        <form action="{{ url('dashboard/update_pengeluaran/' . $pengeluaran->ID_PENGELUARAN) }}" method="POST"
            ...
            <div class="mb-4">
                <label for="ID_PENGELUARAN" class="block text-sm font-medium text-gray-700">ID Pengeluaran:</label>
                <input type="text" name="ID_PENGELUARAN" value="{{ $pengeluaran->ID_PENGELUARAN }}" required
