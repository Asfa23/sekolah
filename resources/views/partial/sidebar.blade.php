<aside class="w-[39vh] h-[90vh] p-6 rounded-lg m-8 bg-gradient-to-t from-purple-600 to-purple-400 flex flex-col items-center space-y-7">         
    ...
    <ul class="space-y-6">        
       ...
       <li>
        ...
        <li>
            <a href="/dashboard/log" class="text-white hover:underline flex items-center">
                <img src="{{ URL::asset("img/history.svg") }}" alt="Payment Icon" class="w-6 h-6 mr-2 font-bold">
                Log Edit & Delete
            </a>
        </li>
