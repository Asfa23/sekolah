...
class CreateLogEditDeletePemasukanTable extends Migration
{
    public function up()
    {
        Schema::create('log_edit_delete_pemasukan', function (Blueprint $table) {
            $table->id('ID_LOG');
    ...
    {
        Schema::dropIfExists('log_edit_delete_pemasukan');
    }
}
